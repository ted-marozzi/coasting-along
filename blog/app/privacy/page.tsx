export default async function Page() {
  return (
    <>
      ...
      <h1 className="py-3">Interpretation and Definitions</h1>
      <h2 className="py-3">Interpretation</h2>
      <p>
        The words of which the initial letter is capitalized have meanings defined under
        the following conditions. The following definitions shall have the same meaning
        regardless of whether they appear in singular or in plural.
      </p>
      <h2 className="py-3">Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Coasting Along, accessible from{" "}
            <a
              href="https://www.coastingalong.blog/"
      ...
      <h1 className="py-3">Collecting and Using Your Personal Data</h1>
      <h2 className="py-3">Types of Data Collected</h2>
      <h3 className="py-3">Personal Data</h3>
      <p>
      ...
      <h3 className="py-3">Usage Data</h3>
      ...
      <h3 className="py-3">Tracking Technologies and Cookies</h3>
      <p>
      ...
      <h2 className="py-3">Use of Your Personal Data</h2>
      ...
      <h2 className="py-3">Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 className="py-3">Transfer of Your Personal Data</h2>
      <p>
      ...
      <h2 className="py-3">Delete Your Personal Data</h2>
      <p>
      ...
      <h2 className="py-3">Disclosure of Your Personal Data</h2>
      <h3 className="py-3">Business Transactions</h3>
      <p>
      ...
      <h3 className="py-3">Law enforcement</h3>
      <p>
      ...
      <h3 className="py-3">Other legal requirements</h3>
      <p>
      ...
      <h2 className="py-3">Security of Your Personal Data</h2>
      <p>
      ...
      <h1 className="py-3">Children&apos;s Privacy</h1>
      <p>
      ...
      <h1 className="py-3">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="py-3">Changes to this Privacy Policy</h1>
      <p>
      ...
      <ul>
        <li>By email: contact@coastingalong.blog</li>
      </ul>
    </>
  );
}
